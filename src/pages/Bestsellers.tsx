...
const Bestsellers = () => {
  ...
  useEffect(() => {
    const loadProducts = async () => {
      try {
        setLoading(true);
        const data = await fetchBestsellers(50);
        setProducts(data);
      } catch (error) {
        ...
        <div className="container mx-auto px-4 pt-16">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg">
              Discover our most loved products, hand-picked by our community. 
              These are the pieces that keep our customers coming back for more.
            </p>
          </motion.div>
        </div>
      </section>
