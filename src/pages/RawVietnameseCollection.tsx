...
export default function RawVietnameseCollection() {
  ...
  return (
    <PageLayout>
      {/* Hero Section */}
      <section className="relative -mx-4 md:-mx-8 lg:-mx-16 -mt-12 mb-12">
        <div className="relative h-[40vh] md:h-[50vh] overflow-hidden">
          <img
            src={rawVietnameseImage}
            alt="Raw Vietnamese Collection"
          ...
          <div className="absolute inset-0 flex items-end justify-center pb-12">
            ...
            >
              ...
              <p className="text-muted-foreground mt-4 max-w-xl mx-auto px-4">
                The pinnacle of luxury hair. 100% raw, unprocessed Vietnamese hair 
                with intact cuticles for the most natural look and longest lifespan.
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="mt-16 bg-card rounded-2xl p-8 md:p-12">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Our Raw Vietnamese collection represents the highest quality hair available. 
            Unlike processed virgin hair, raw hair has never been treated with any chemicals 
            or steam processing. Each strand maintains its natural cuticle alignment from root 
            to tip, resulting in hair that behaves exactly like your own. This premium quality 
            means your investment will last for years with proper care.
          </p>
        </div>
      </section>
    </PageLayout>
